...
import dashboard1 from '/pages1/dashboard1.html'
import whiteboard from '/pages/whiteboard.html'
import thermolab from '/pages1/thermolab.html'
import computerlab from '/pages1/computerlab.html'
...
$(document).ready(function() {
    ...
    $('#lab-button').click(() => {
        ...
        openLab()
        $('#new-whiteboard').click(newThermolab)
        $('#new-complab').click(newComplab)
    })
})

function openLab(direction='down') {
    switchTo(dashboard1, direction)
...
function newThermolab()
{
    switchTo(thermolab,false)
    window.globalSocket.emit('openThermolab')
}
function newComplab()
{
    switchTo(computerlab,false)
    window.globalSocket.emit('openComplab')
}
